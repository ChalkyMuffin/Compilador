...
public class ExprParser extends Parser {
	...
	public static final int
		RULE_prog = 0, RULE_vars_decl = 1, RULE_funcs_decl = 2, RULE_body = 3, 
		RULE_statement = 4, RULE_assign = 5, RULE_condition = 6, RULE_cycle = 7, 
		RULE_f_call = 8, RULE_printExpr = 9, RULE_expression = 10, RULE_term = 11, 
		RULE_factor = 12, RULE_relExpr = 13, RULE_cte = 14, RULE_params = 15, 
		RULE_param = 16, RULE_type = 17;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "vars_decl", "funcs_decl", "body", "statement", "assign", "condition", 
			"cycle", "f_call", "printExpr", "expression", "term", "factor", "relExpr", 
	...
	public final F_callContext f_call() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_f_call);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
